...
public class SystemCommandExecutor {
    ...
    static final Logger logger = LoggerFactory.getLogger(SystemCommandExecutor.class);
    ...
    @Timeable(limit = 15, unit = TimeUnit.SECONDS)
    int executeCommand()
        ...
        if (Thread.currentThread().isInterrupted()) {
            throw new IllegalStateException("Command Execution time out");
        }
